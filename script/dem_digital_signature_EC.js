...
function mainProcedure() {
	show('\n\nTo do Sign and Verify, we need EC key-pair, signing Algorithm and Plain Text.\n'
		+'It is recommended that to invoke this service, invoke Key Pair Generation Service first!...\n'
		+'We will do the following steps...\n '
		+'1. Restore MSE\n'
		+'2. SET MSE with Signature Algorithm: ALG_ECDSA_SHA_224\n'
...
//	/********	RSA Sign generation and verification ENDs	********/
	...
	show('\nSETing MSE with Signature Algorithm: ALG_ECDSA_SHA_512');
	execute("00 22 F1 B6 03 8001 21");
//	keypairType = '14';
