...
function mainProcedure() {
	show('\n\nFor Message Authentication, we need MAC key, MAC Algorithm and Plain Text.\n'
		+'It is recommended that to invoke this service invoke Update Demo Key Service first!...\n'
		+'We will do the following steps...\n '
		+'1. Restore MSE with MAC algo ALG_AES_MAC_128_NOPAD\n'
		+'2. Generate MAC and Verify\n');
...
//	putMACkey();
	show('\nSETing MSE with  Algorithm: ALG_AES_CMAC_128');
	execute("00 22 F1 B6 03 8001 01");
